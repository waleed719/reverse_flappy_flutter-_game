...
class LocalStoragePlayerProgressPersistence extends PlayerProgressPersistence {
  ...
  @override
  Future<List<String>> getTopScores() async {
    final prefs = await instanceFuture;
    return prefs.getStringList('topScore') ?? [];
  }

  @override
  Future<void> saveTopScores(List<String> scores) async {
    final prefs = await instanceFuture;
    await prefs.setStringList('topScore', scores);
  }
}
